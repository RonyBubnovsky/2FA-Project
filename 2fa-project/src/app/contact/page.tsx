    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-secondary-900 dark:text-white mb-4">
          Get in Touch
        </h1>        <p className="text-lg text-secondary-600 dark:text-secondary-400 max-w-2xl mx-auto">
          ...
          <div className="bg-white dark:bg-secondary-900 rounded-xl shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-secondary-900 dark:text-white mb-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="font-semibold text-secondary-900 dark:text-white">Email</h3>                  <p className="text-secondary-600 dark:text-secondary-400">
            ...
            {submitStatus === 'success' && (
              <div className="mb-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                <div className="flex items-center">
                  ...
                  </svg>                  <p className="text-green-700 dark:text-green-300">
