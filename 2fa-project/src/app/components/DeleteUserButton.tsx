  ...
  return (
    <>
      <button
        ...
        className="bg-red-600 hover:bg-red-700 text-white px-3 sm:px-4 py-2 rounded-md font-medium transition-colors duration-200 flex items-center text-sm whitespace-nowrap"
